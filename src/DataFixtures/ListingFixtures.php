    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            ...
            $listing
                ...
                ->setUser($this->getReference('user_' . rand(0, 4), User::class))
                ->setTransactionType($this->getReference('transaction_type_' . rand(0, 4), TransactionType::class))
                ->setPropertyType($this->getReference('property_type_' . rand(0, 8), PropertyType::class))
            ;
